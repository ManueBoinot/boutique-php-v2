...
<section class="section-connexion container mx-auto p-3">
    <div class="row p-5" style="background-color: rgba(255,255,255,0.7);">
        ...
        <div class="row">
            <form class="col-10 offset-1 border p-5 bg-light">
            <h2 class="text-center p-3">Se connecter</h2>
                ...
                <div class="row my-3 px-5">
                    <button type="submit" class="col-4 offset-4 btn btn-outline-primary fw-bold" style="border-color: darksalmon;"><a href="profil.php" class="text-decoration-none" style="color: darksalmon;">Se connecter</a></button>
                </div>
            </form>
        </div>
