        ...
        <div class="row px-5 mx-auto">
            <form action="connexion.php" method="post" class="row bg-light border p-5 gap-2">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <label for="inputAdresseCompl" class="form-label">Complément d'adresse</label>
                        <input type="text" name="adresseCompl" class="form-control" id="inputAdresseCompl" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <label for="inputCommune" class="form-label">Commune</label>
                        <input type="text" name="commune" class="form-control" id="inputCommune" required>
                    </div>
                </div>
